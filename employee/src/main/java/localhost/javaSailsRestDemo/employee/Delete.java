...
/**
 * 
 * Sample class that DELETED one JSON object from a  SAIL API named employee
 * 
 * @author Mary Ches
 * @since 2016-09-07
 *
...
public class Delete 
{
	...
	public static void main(String[] args) 
	{
		try
		{
			//Employee ID number for object you wish to delete
			String userID = "id=21";
			
			//creates a new URL out of the endPoint that will retrieve all employees 
