...
/**
 * 
 * Sample class that GETS one JSON object from a  SAIL API named employee
 * 
 * @author Mary Ches
 * @since 2016-09-07
 *
...
public class GetSingle 
{
	...
	public static void main(String[] args) 
	{
		try
		{
			//Employee ID number for object you wish to retrieve
			String userID = "id=25";
			
			//creates a new URL out of the endPoint that will the employee 
