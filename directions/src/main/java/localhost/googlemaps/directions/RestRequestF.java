 ...
 * Using Mass Transit with specific departure time and fewest transfers
 * 
 * @author Mary Ches
 * @since 2016-09-06
 *
...
public class RestRequestF 
{
	...
	public static void main(String[] args) 
	{
		try {
			...
			//Departure Time: 9/14/16 at 8:00am Local Time
			String departure_time = "1473854400";
			
			//The bus route preference
			String transit_routing_preference = "fewer_transfers";
			...
			String queryString = String.format("origin=%s&destination=%s&key=%s&mode=%s&transit_mode=%s&departure_time=%s&transit_routing_preference=%s", 
					...
					URLEncoder.encode(transit_routing_preference, charset));
